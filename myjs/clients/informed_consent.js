...
const date_informed_consent0 = document.getElementById(
  "date_informed_consent0"
);
const date_informed_consent = document.getElementById("date_informed_consent");

function toggleElementVisibility() {
  if (informed_consent1.checked) {
    date_informed_consent0.style.display = "block";
    ...
    date_informed_consent0.style.display = "none";
  } else {
    date_informed_consent.removeAttribute("required");
    date_informed_consent0.style.display = "none";
  }
