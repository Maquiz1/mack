...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $dataDictionary = [
        [
            'field_name' => 'ncd_screening',
            'field_label' => '5.1 Have you ever been screened for non-communicable diseases?',
            'field_type' => 'select',
            'required' => 'No',
            'values' => "1=Yes\n2=No",
            'units' => '',
        ...
        [
            'field_name' => 'chronic_illness_type',
            'field_label' => '5.2 Name of chronic illness',
            'field_type' => 'text',
            'required' => 'No',
            'values' => '',
            'units' => '',
        ...
        [
            'field_name' => 'start_date_chronic',
            'field_label' => '5.2 Start Date',
            'field_type' => 'date',
            'required' => 'No',
            'values' => '',
            'units' => '',
        ...
        [
            'field_name' => 'chronic_illnesses_specify_complete',
