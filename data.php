...
<head>
    ...
    <title>Mack Database | Data</title>
                                        ...
                                        <table id="search-results" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($override->AllTables() as $tables) {
                                                    ...
                                                    if (
                                                        $tables['Tables_in_mack'] == 'clients' ||
                                                        $tables['Tables_in_mack'] == 'hiv_history_and_medication' ||
                                                        $tables['Tables_in_mack'] == 'eligibility' ||
                                                        $tables['Tables_in_mack'] == 'risk_factors' ||
                                                        $tables['Tables_in_mack'] == 'medications' ||
                                                        $tables['Tables_in_mack'] == 'chronic_illnesses' ||
                                                        $tables['Tables_in_mack'] == 'laboratory_results' ||
                                                        $tables['Tables_in_mack'] == 'radiological_investigations'
                                                        // $tables['Tables_in_mack'] == 'visit'
                                                    ) {
                                                ?>
                                                        <tr>
                                                            <td class="table-user">
                                                            ...
                                                            <td>
                                                                <input type="hidden" name="table_id" value="<?= $tables['Tables_in_mack']; ?>">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="table_name[]" id="table_name[]" value="<?= $tables['Tables_in_mack']; ?>" <?php if ($tables['Tables_in_mack'] != '') {
                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                    } ?>>
                                                                    <label class="form-check-label"><?= $tables['Tables_in_mack']; ?></label>
                                                                </div>
                                                            </td>
                                                            <td class="table-user">
                                                                <?= $override->getCount($tables['Tables_in_mack'], 'status', 1); ?>
                                                            </td>
                                                            <td class="table-user text-center">
                                                                <form method="post">
                                                                    <input type="hidden" name="data" value="<?= $x; ?>">
                                                                    <input type="hidden" name="table" value="<?= $tables['Tables_in_mack']; ?>">
