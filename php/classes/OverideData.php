...
class OverideData
{
    ...
    // public function CountByMonthAll($table, $where1)
    // {
    //     $query = $this->_pdo->query("SELECT DATE_FORMAT($where1, '%Y-%m') as month, COUNT(*) as count
    //     FROM $table
    //     GROUP BY DATE_FORMAT($where1, '%Y-%m')");
    ...
    // public function ListByMonthAll($table1, $table2, $where1)
    // {
    ...
    //         UNION
    //         SELECT 
    //             DATE_FORMAT(t2.$where1, '%Y-%m') as month,
    //             COUNT(t1.$where1) as count1,
    //             COUNT(t2.$where1) as count2
    //         FROM 
    //             $table2 t2
    ...
    public function CountByMonthAllTables($table, $where1)
    {
        $query = $this->_pdo->query("SELECT DATE_FORMAT($where1, '%Y-%m') as month, COUNT(*) as count
        FROM $table
        GROUP BY DATE_FORMAT($where1, '%Y-%m')");
